...
fn handle_ai_chat(
    ...
    // Plan 072 M2 (S-3/S-5): approval gate + policy passthrough — the agent's
        ...
        while let Ok(ev) = ev_rx.try_recv() {
            match ev {
                ...
                ChatEv::Done(result) => {
                    ...
                    // Plan 072 M2 (S-3): approval gate — drain everything the
...
/// Plan 072 M2 (S-3): present an AI-proposed command for approval. Returns
