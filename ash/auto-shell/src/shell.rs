...
pub struct Shell {
    ...
    /// Plan 072 M2 (S-5): the reason of the most recent policy denial within
...
impl Shell {
    ...
    pub fn new() -> Self {
        ...
        let registry = {
            ...
            reg.register(Box::new(commands::show::ShowCommand));
    ...
    pub fn execute(&mut self, input: &str) -> Result<Option<String>> {
        ...
        self.last_denial = None; // Plan 072 M2: per-execute denial trace
    ...
    /// `execute()` call. Plan 072 M2: used by agent bridges (`eval_auto`'s
