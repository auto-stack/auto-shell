...
| **029** | AI 能力增强(含 SmartCommand) | ✅ 1064 行（v1 已过时，§0 已重评） | ❌ 待写 | auto-ai 侧 3-4 周 + auto-shell 侧 6-8 周（v1 估 12-16 周，因改用 auto-ai-agent harness 而减半） |
| **030** | ash-gui(Shell-native UI) | ✅ 1048 行 | ✅ 1671 行(M0-M2) | 13-20 周(M0-M5) |
| **031** | 数据处理框架(lazy pipeline) | ✅ 538 行 | ❌ 待写 | 4-6 周 |
| **032** | 智能补全(AI 层) | ✅ 405 行 | ❌ 待写 | 4-5 周 |
| **033** | 插件生态(data-only) | ✅ 437 行 | ❌ 待写 | 3-4 周 |
| **034** | 脚本实例库 | ✅ 194 行 | ❌ 待写 | 1-2 周 |
